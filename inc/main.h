...
#define GENERATIONS 10000 // Всего поколений

#define INIT_POP_SIZE 30 // Размер популяции
#define SKIP_GENERATIONS 100 // Кол-во пропусков раундов/поколений
...
#define AGENT_MUTATION_POWER 0.15f // Число-диапозон (+, -), которое суммируется с каждым весом
#define AGENT_CHANCE_TO_CROSS_OVER 0.5f // Шанс скрещивания (кроссинговера)
