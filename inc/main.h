...
#define INIT_POP_SIZE 30 //25 Размер популяции
...
#define NEURONS_IN_HIDDEN_LAYER 18 //13 Кол-во нейронов в скрытых(ом) слоях(е) // (одинаково)
#define OUTPUT_VALUES 4 // Выходные значения

#define AGENT_MUTATION_CHANCE 0.15f //0.1 Шанс мутации гена
#define AGENT_MUTATION_POWER 0.8 //0.4 Число-диапозон (+, -), которое суммируется с каждым весом
#define AGENT_CHANCE_TO_CROSS_OVER 0.3f //0.2 Шанс скрещивания (кроссинговера)
