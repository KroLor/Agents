...
#define GENERATIONS 50000 // Всего поколений
#define SKIP_GENERATIONS 0 // Кол-во пропусков раундов/поколений

#define INIT_POP_SIZE 30 //40 Размер популяции
#define NUMBER_OF_STEPS 50 // Кол-во шагов в раунде
#define INIT_ENERGY_AGENT 125 // Кол-во энергии у агента
#define ENERGY_LOSS_PER_STEP 5 //4 Потеря энергии за шаг //
#define ENERGY_LOSS_DUE_TO_INACTION 5 //6 Потеря энергии за бездействие //
...
#define ENERGY_FOOD_VALUE 30 //40 Энергетическая ценность еды //
...
#define NEURONS_IN_HIDDEN_LAYER 7 //13 Кол-во нейронов в скрытых(ом) слоях(е) // (одинаково)
#define OUTPUT_VALUES 4 // Выходные значения

#define AGENT_MUTATION_CHANCE 0.1f // Шанс мутации гена
#define AGENT_MUTATION_POWER 0.4 // Число-диапозон (+, -), которое суммируется с каждым весом
