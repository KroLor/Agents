...
#define NUMBER_OF_STEPS 125 // Кол-во шагов в раунде
#define INIT_ENERGY_AGENT 200 // Кол-во энергии у агента
#define ENERGY_LOSS_PER_STEP 0 //3 Потеря энергии за шаг //
#define ENERGY_LOSS_DUE_TO_INACTION 4 //3 Потеря энергии за бездействие //
...
#define AGENT_MUTATION_POWER 0.2f // Число-диапозон (+, -), которое суммируется с каждым весом
