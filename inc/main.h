...
#define TICK_MS 200 // Интервал между тиками (мс)
...
#define AGENT_MUTATION_CHANCE 0.08f // Шанс мутации гена
#define AGENT_MUTATION_POWER 0.1f // Число-диапозон (+, -), которое суммируется с каждым весом
#define AGENT_CHANCE_TO_CROSS_OVER 0.15f // Шанс скрещивания (кроссинговера)
