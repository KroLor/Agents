...
#define INIT_POP_SIZE 5 //5 35 Размер популяции
...
#define INIT_FOOD_COUNT 150 //75 100 150 Кол-во еды, появляющейся в начале раунда
#define FOOD_SPAWN_INTERVAL 25 //15 25 Каждый N-й тик появляется еда
...
#define NEURONS_IN_HIDDEN_LAYER 3 //3 5 Кол-во нейронов в скрытых(ом) слоях(е) // (одинаково)
#define OUTPUT_VALUES 4 // Выходные значения

#define AGENT_MUTATION_CHANCE 0.2f //0.1f Шанс мутации гена
#define AGENT_MUTATION_POWER 0.3f //0.02f Число-диапозон (+, -), которое суммируется с каждым весом
#define AGENT_CHANCE_TO_CROSS_OVER 0.4f //0.33f Шанс скрещивания (кроссинговера)
