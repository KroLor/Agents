...
#define GENERATIONS 50000 //100 Всего поколений

#define INIT_POP_SIZE 30 // Размер популяции
#define SKIP_GENERATIONS 1000 //10 Кол-во пропусков раундов/поколений
#define NUMBER_OF_STEPS 75 //30 Кол-во шагов в раунде
#define INIT_ENERGY_AGENT 100 // Кол-во энергии у агента
#define ENERGY_LOSS_PER_STEP 5 // Потеря энергии за шаг //
#define ENERGY_LOSS_DUE_TO_INACTION 10 // Потеря энергии за бездействие //

#define INIT_FOOD_COUNT 100 // Кол-во еды, появляющейся в начале раунда
#define FOOD_SPAWN_INTERVAL 5 //2 Каждый N-й тик появляется еда
...
#define TICK_MS 75 // Интервал между тиками (мс)
...
#define AGENT_MUTATION_CHANCE 0.3f // Шанс мутации гена
#define AGENT_MUTATION_POWER 0.25f // 