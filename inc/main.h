...
#define INIT_POP_SIZE 40 // Размер популяции
#define SKIP_GENERATIONS 1000 // Кол-во пропусков раундов/поколений
#define NUMBER_OF_STEPS 100 // Кол-во шагов в раунде
...
#define TICK_MS 150 // Интервал между тиками (мс)
...
#define AGENT_MUTATION_POWER 0.3333 // Число-диапозон (+, -), которое суммируется с каждым весом
